...
/** @Auther: hepengrui @Date: 2018/12/17 17:39 @Description: */
@Slf4j
public class ExcelUtils {
  ...
  /** 默认行高 */
  private static final short DEFAULT_ROW_HEIGHT = (short) (21.5 * 20);

  public static <T> List<T> readExcel(
      InputStream inputStream, String fileName, Class<T> rowObjectClass, List<String> fieldNames) {
    return readExcel(
        inputStream, fileName, rowObjectClass, FIRST_INDEX, fieldNames, SECOND_INDEX, FIRST_INDEX);
  }

  public static <T> List<T> readExcel(
      InputStream inputStream,
      String fileName,
      Class<T> rowObjectClass,
      int sheetIndex,
    ...
    return readExcel(
        workbook, rowObjectClass, sheetIndex, fieldNames, startRowIndex, startCellIndex);
  }
   ...
   * @return
   */
  public static <T> List<T> parseSheetToObejct(
      Sheet sheet,
      Class<T> rowObjectClass,
      List<String> fieldNames,
      int startRowIndex,
   ...
   * @return
   */
  public static <T> T parseRow2Object(
      Class<T> rowObjectClass, List<String> fieldNames, Row row, int startCellIndex) {
  ...
  private static <T> void setProperty(Class<T> clazz, T obj, String fieldName, String value) {
    ...
    try {
      ...
      log.error(
          "failed to set the propertyName method,the propertyName is:{},the value is:{},the obj is {}",
          fieldName,
          value,
          obj,
          e);
  ...
  public static <T> Workbook export2Excel(
      Class<T> rowObjectClass,
      List<T> rowObjectList,
      String sheetName,
      List<String> fieldNames,
      List<String> headers) {
    return export2Excel(
  ...
  public static <T> Workbook export2Excel(
    ...
    if (wb == null
        || rowObjectClass == null
        || CollectionUtils.isEmpty(fieldNames)
  ...
  private static <T> Object getProperty(Class<T> rowObjectClass, T obj, String fieldName) {
    ...
    try {
      ...
      log.error(
          "fail to get the fieldName method,the fieldName is:{},this obj is :{}",
          fieldName,
          obj,
          e);
    }
